...
import PopupTimeOut from '../Common/PopupTimeOutView';
import {
    Notifications,
    Constants,
    Expo,
...
export default class BasePureComponent extends PureComponent {
    ...
    */
    ...
    onCheckErrorCode(error_code, error_msg) {
        console.log("error code tra ve la : ", error_code);
        if (error_code === 2) {
            let _navigation = PropsStatic.getNavigator();
            if (_navigation) {
                console.log("props static not null");
            ...
            if (screenProps) {
                ...
                console.log("grandparentNavigation baseComponent1 : ", grandparentNavigation);
            ...
            console.log("grandparentNavigation baseComponent2 : ", grandparentNavigation);
            if (grandparentNavigation) {
                this.loginOtherDevice(grandparentNavigation);
                return;
            }
    ...
    renderLoading() {
        return (
            <View>
                <LoadingView ref={(loading) => { this.loading = loading; }} />
                <PopupTimeOut ref={(popupTimeOut) => { this.popupTimeOut = popupTimeOut; }} />
            </View>
        );
    }
