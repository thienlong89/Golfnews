...
function startActivityAsync(activity, data = null) {
  if (Platform.OS === 'android') {
    return SendIntentAndroid.openSettings(activity);//NativeModules.ExponentIntentLauncher.startActivity(activity, data);
  } else {
...
const ACTION_NETWORK_OPERATOR_SETTINGS = 'android.settings.WIFI_SETTINGS';
