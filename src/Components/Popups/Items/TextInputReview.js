        ...
        return (
            <View style={this.props.style}>
                <TextInput allowFontScaling={global.isScaleFont}
                    style={{color : '#a6a6a6', paddingTop: 0, paddingBottom: 0,paddingLeft : 0,paddingRight : 0,fontWeight : this.props.fontWeight ? this.props.fontWeight : 'normal',fontSize : this.props.fontSize ? this.props.fontSize : fontSize(15,scale(1)),lineHeight : this.props.lineHeight ? this.props.lineHeight : fontSize(15,scale(1) + verticalScale(4))}}//flex : 1,
