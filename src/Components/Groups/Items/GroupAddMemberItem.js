...
export default class GroupAddMemberItem extends BaseComponent {
    ...
    render() {
        ...
        let ehandicapClub = player.getEhandicapClub() || '';
        //let memberStatus = player.getClubMember().is_accepted === undefined ? -1 : player.getClubMember().is_accepted;
        let isModelSelected = false;// player.isSelected || false;
        let memberStatus = -1; //player.IsGroupMember() ? 1 : memberStatus;
    ...
    onMemberItemPress(memberStatus, isModelSelected) {
        console.log('onMemberItemPress.isModelSelected', isModelSelected)
