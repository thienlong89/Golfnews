...
export default class EventInviteClubItem extends BaseComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    /**
     * Gui lời mời đến club
     */
    onSendInviteClick() {
        let { data, event_id } = this.props;
        let url = this.getConfig().getBaseUrl() + ApiService.event_send_invite_to_club(event_id, data.getId());
        console.log("url:",url);
        let self = this;
        this.showLoading();
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    <Text allowFontScaling={global.isScaleFont} style={styles.name}>{data.getName()}</Text>
