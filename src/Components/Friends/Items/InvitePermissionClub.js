...
export default class InvitePermissionClub extends BaseComponent {
            ...
            return (
                <View style={styles.container}>
                    ...
                    <View style={styles.view_right}>
                        <Text allowFontScaling={global.isScaleFont} style={styles.txt_introduce}>{type === 1 ? this.t('invited_secretary_general').format(club.name) : this.t('invited_moderator_club').format(club.name)}</Text>
    ...
    onAcceptJoinClub() {
        if (this.props.onAcceptJoinClub) {
            this.props.onAcceptJoinClub(this.props.type);
        }
    }

    onDenyJoinClub() {
        if (this.props.onDenyJoinClub) {
            this.props.onDenyJoinClub(this.props.type);
        }
    }
