...
export default class FavoriteCourseTab extends BaseComponent {
    ...
    static navigationOptions = () => ({
        title: I18n.t("favorite"),               // it stay in french whatever choosen langage
        tabBarLabel: I18n.t("favorite"),
    });
    ...
    onStartTutorialUpgrade() {
        console.log('onStartTutorialUpgrade.Favorite');
