...
export default class AddAdminItemView extends BaseComponent {
    ...
    render() {
        ...
        return (
            <Touchable onPress={this.onMemberItemPress.bind(this, isModelSelected)}>

                <View style={styles.container}>

                    <View style={styles.view_img}>
                        <Image style={styles.img_check}
                            source={this.getSourceStatus(isModelSelected)} />
                    </View>
    ...
    onMemberItemPress(isModelSelected) {
    ...
    resetState(){
        this.props.player.isSelected = false;
        this.setState({
            isSelected: false
        }, () => {
