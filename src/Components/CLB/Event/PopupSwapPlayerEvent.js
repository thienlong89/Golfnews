...
export default class PopupSwapPlayer extends BaseComponent {
    ...
    renderSectionHeader({ index, max_member, event_id, flight_event_id }) {
    ...
    requestEventFlight() {
        ...
        // }
        let self = this;
        let url = this.getConfig().getBaseUrl() + ApiService.event_member_list_flight(this.page);
        let formData = {
