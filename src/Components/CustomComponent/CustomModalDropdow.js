...
export default class CustomModalDropdown extends Component {
  static propTypes = {
      ...
      >
        {
          ...
          (
            <View style={styles.button}>
              <Text allowFontScaling={global.isScaleFont} style={[styles.buttonText, textStyle]}
                    numberOfLines={1}
              >
                {buttonText}
              </Text>
        ...
        >
          ...
          >
            <View style={styles.modal}>
              <View style={[styles.dropdown_view, dropdownStyle, frameStyle]}>
  ...
  _calcPosition() {
    ...
    const showInBottom = bottomSpace >= dropdownHeight+((13 + StyleSheet.hairlineWidth) * 5) || bottomSpace >= this._buttonFrame.y;
    // const showInBottom = bottomSpace >= dropdownHeight || bottomSpace >= this._buttonFrame.y;
    const showInLeft = rightSpace >= this._buttonFrame.x;
    console.log('................... dropdownHeight',dropdownHeight,(6 + StyleSheet.hairlineWidth) * 5,this._buttonFrame.y);
    const positionStyle = {
      // height: dropdownHeight,
      top: showInBottom ? this._buttonFrame.y + this._buttonFrame.h : Math.max(0, this._buttonFrame.y - dropdownHeight + ((6 + StyleSheet.hairlineWidth) * 5)),
  ...
  _renderRow = (rowData, sectionID, rowID, highlightRow) => {
    ...
    const row = !renderRow ?
      (<Text allowFontScaling={global.isScaleFont} style={[
        styles.rowText,
        dropdownTextStyle,
