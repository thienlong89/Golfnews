...
class ImageLoad extends BaseComponent {
    static propTypes = {
            ...
            >
                {
                    (this.state.isLoaded && !this.state.isError) ? children :
                        ...
                        >
                            ...
                            <Image
                                style={placeholderStyle ? [placeholderStyle, { tintColor: '#838383' }] : [styles.imagePlaceholderStyles, customImagePlaceholderDefaultStyle, { tintColor: '#838383' }]}
                                source={placeholderSource ? placeholderSource : this.getResources().ic_picture}
                            >
                            </Image>
                        </View>
                }
