...
class PhotoGridView extends PureComponent {
                                    ...
                                    {this.isLastImage(index, secondViewImages) ? (
                                        ...
                                        >
                                            <View style={styles.lastWrapper}>
                                                <Text allowFontScaling={global.isScaleFont} style={[styles.textCount, this.props.textStyles]}>+{this.props.numberImagesToShow || this.props.source.length - 5}</Text>
                                            </View>
                                        </ImageBackground>
                                    )
                                        : <ImageLoad
